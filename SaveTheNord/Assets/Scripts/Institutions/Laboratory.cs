    ...
    public class Laboratory : MonoBehaviour
    {
        ...
        IEnumerator MoveCrystal()
        {
            ...
            while (true)
            {
                ...
                {
                    var t = Misc.Tween(ref lerpPosition, _crystalMoveTime, easingType: Easings.Type.SineInOut);
                ...
                {
                    var t = Misc.ReverseTween(ref lerpPosition, _crystalMoveTime, easingType: Easings.Type.SineInOut);
                    _crystal.transform.localPosition = Vector3.Lerp(_minCrystalPosition, _maxCrystalPosition, t);
                    yield return null;
                }
            }
